...
11. Every day needs real content between the meals, not just the meals. Two restaurants and nothing else is not a light day, it is an empty one — fill the hours in between with sightseeing, activities, or explicit free time, using the supplied candidates. Spread activities roughly evenly across every day of the trip. A trip with one day carrying most of the sightseeing and the rest left nearly bare is a planning failure even if every individual item is otherwise correct.
